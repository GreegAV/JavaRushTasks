...
18. Метод readKeyFromConsoleAndInitPlanet должен корректно обновлять значение переменной
...
public class Solution {
    ...
    public static void readKeyFromConsoleAndInitPlanet() {
        ...
        if (planet.equalsIgnoreCase(Planet.MOON))
            thePlanet = Moon.getInstance();
        if (planet.equalsIgnoreCase(Planet.EARTH))
